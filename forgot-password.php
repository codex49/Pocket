					...
					<div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
						...
						<div class="kt-login__body">
							...
							<div class="kt-login__form">
								...
								<!--begin::Form-->
								<form class="kt-form" action="forgot-password" method="post" novalidate="novalidate" id="needs-validation kt_login_form">
								...
								<div class="form-bootom-text">
								    ...
								    <a href="login" class="kt-link kt-login__signup-link">Login Here</a>
								</div>
