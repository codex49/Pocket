								...
								<div class="kt-container ">
									<div class="kt-subheader__main">
										...
										<div class="kt-subheader__breadcrumbs">
											...
											<span class="kt-subheader__breadcrumbs-separator"></span>
											<a href="profile" class="kt-subheader__breadcrumbs-link">Profile</a>
										</div>
									</div>
												...
												<div class="kt-widget kt-widget--user-profile-1">
													...
													<div class="kt-widget__body">
														...
														<div class="kt-widget__items">
															<a href="profile" class="kt-widget__item kt-widget__item--active">
															...
															<a href="change-password" class="kt-widget__item ">
																<span class="kt-widget__section">
																	<span class="kt-widget__icon">
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															...
															<a href="transactions" class="kt-widget__item">
																<span class="kt-widget__section">
																	<span class="kt-widget__icon">
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															...
															<a href="refer" class="kt-widget__item">
																<span class="kt-widget__section">
																	<span class="kt-widget__icon">
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	...
																	<div class="form-group row">
																		...
																		<div class="col-lg-9 col-xl-6">
																			<div class="input-group">
																				...
																				<input type="email" class="form-control" name="email" value="<?php echo esc_attr($req_user_info['email']); ?>" placeholder="Email Address" required>
																			</div>
																		</div>
																	</div>
