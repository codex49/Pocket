<?php
    ...
    $default_offerwalls = array("adgatemedia", "adscendmedia", "cpalead", "wannads", "kiwiwall", "admantum");
...
<script type="text/javascript">
    ...
    function show_offerwall(offerwall) {
        ...
        $('.offer-walls .kt-portlet__body').removeClass('kt-hidden')

        $('html, body').animate({
            scrollTop: parseInt($(".offer-walls .kt-portlet__body").offset().top) - 100
        }, 500);
