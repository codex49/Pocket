						...
						<div class="kt-login__body">
							...
							<div class="kt-login__form">
								...
								<div id="signin_layout">
								    ...
								    <!--begin::Form-->
                                    <form class="kt-form" name="signin_form" id="needs-validation kt_login_form" action="login" method="post" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" placeholder="Email Address" id="user_username" autocomplete="off" maxlength="60" id="user_username" name="user_username" type="text" value="<?php echo esc_attr($user_username); ?>" required="">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="kt-login__options mb-4">
                                        ...
                                        <a href="includes/oauth.php?provider=Facebook" class="btn btn-primary kt-btn">
                                        ...
                                        <a href="includes/oauth.php?provider=Google" class="btn btn-danger kt-btn">
								...
								<div class="form-bootom-text">
								    ...
								    <a href="index" class="kt-link kt-login__signup-link">Sign Up!</a>
								</div>
								<!--end::Register-->
